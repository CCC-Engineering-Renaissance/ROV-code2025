...
int main() {
  ...
  while(1){
  AccX = (lgI2cReadByteData(handle, 0x3B) << 8 | lgI2cReadByteData(handle, 0x3C) ) / 16384.0; // X-axis value
  AccY = ( lgI2cReadByteData(handle, 0x3D) << 8 | lgI2cReadByteData(handle, 0x3E)/ 16384.0; // Y-axis value
  AccZ = (lgI2cReadByteData(handle, 0x3F)<< 8 | lgI2cReadByteData(handle, 0x40)/ 16384.0; // Z-axis value
